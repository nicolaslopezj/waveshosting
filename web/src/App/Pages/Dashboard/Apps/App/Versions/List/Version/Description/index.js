...
@withMutation(gql`
  mutation setDescription($appId: ID, $versionLabel: String, $description: String) {
    setVersionDescription(appId: $appId, versionLabel: $versionLabel, description: $description) {
      label
      description
    }
  }
  ...
  async setDescription(description) {
    ...
    try {
      await this.props.setDescription({
        ...
        versionLabel: this.props.version.label,
        description
      })
